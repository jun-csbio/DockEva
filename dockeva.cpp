...
double g_eps = 1e-9;
double g_inf = 1e+99;
double g_seconds = 600; // 600 seconds
...
inline void Ligand::load_from_sdf(const string& path, const bool& is_load_H, const bool& is_care_bond_type){
	...
	if (__size < 5){
		...
		cout << "Please check it or use OpenBabel tool to format it!" << endl;
		exit(-1);
	}
